...
def unite_tables():
    users = get_data_from_api("https://zalooawebhook.demo.mqsolutions.vn/api/users?skip=0&limit=20")
    ...
    for issue in issues["tasks"]:
        ...
        for assignment in assignments["assignments"]:
            if assignment["task_id"] == issue["id"]:
                ...
                assignee_index = {a["id"]: a["name"] for a in users["users"]}
        ...
        enriched = {
            ...
            "completed_at": issue["complete_at"],
